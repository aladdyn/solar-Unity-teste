...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:ᏟϴᎡᏙϴ\n' // Nama kamu
            + 'SOLAR UNITY BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=554196979697:+55 4196979697\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '#','!','.','*'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `tchau @${num.split('@')[0]} La se vai o gado 😂👋\nTriste, abandonado e sozinho.`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ Espere um pouco, cerca de 2 milésimos',
					success: '️❬ ✔ ❭ Sucesso 🖤',
			...
			const premium = ["554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net","554196979697@s.whatsapp.net"]
